...
public class NurseRole extends AnnotatedRoleDefinition {
    ...
    @EntityAccess(entityClass = EntityAttributeComment.class, operations = {EntityOp.READ})
    @EntityAccess(entityClass = VisitDocumentation.class, operations = {EntityOp.CREATE, EntityOp.READ, EntityOp.UPDATE, EntityOp.DELETE})
    @Override
    ...
    @EntityAttributeAccess(entityClass = Visit.class, modify = "pet")
    // TODO: remove when https://github.com/cuba-platform/cuba/issues/2869 is solved
    @EntityAttributeAccess(entityClass = EntityAttributeComment.class, view = "*")
    @EntityAttributeAccess(entityClass = VisitDocumentation.class, modify = "*")
    @EntityAttributeAccess(entityClass = VisitDocumentation.class, modify = "visit")
    @Override
