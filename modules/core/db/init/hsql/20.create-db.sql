...
alter table PETCLINIC_VISIT_DOCUMENTATION add constraint FK_PETCLINIC_VISIT_DOCUMENTATION_VISIT foreign key (VISIT_ID) references PETCLINIC_VISIT(ID)^
create index IDX_PETCLINIC_VISIT_DOCUMENTATION_VISIT on PETCLINIC_VISIT_DOCUMENTATION (VISIT_ID)^
